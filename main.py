...
style1 = xlwt.easyxf('pattern: pattern solid, fore_colour red;''font: colour white, bold True;')
style2 = xlwt.easyxf('pattern: pattern solid, fore_colour blue;''font: colour white, bold True;')
style3 = xlwt.easyxf('pattern: pattern solid, fore_colour pink;''font: colour white, bold True;')
style4 = xlwt.easyxf('pattern: pattern solid, fore_colour pale_blue;''font: colour white, bold True;')
stylered = xlwt.easyxf('font: colour red, bold True;')
styleblue = xlwt.easyxf('font: colour blue, bold True;')
styleblank = xlwt.easyxf('pattern: pattern solid, fore_colour black;''font: colour white, bold True;')
styleb = xlwt.easyxf('font: colour black, bold True;')

style70 = xlwt.easyxf('pattern: pattern solid, fore_colour red;''font: colour white, bold True;')
style50 = xlwt.easyxf('pattern: pattern solid, fore_colour light_orange;''font: colour white, bold True;')
style30 = xlwt.easyxf('pattern: pattern solid, fore_colour pale_blue;''font: colour white, bold True;')
style0 = xlwt.easyxf('pattern: pattern solid, fore_colour bright_green;''font: colour black, bold True;')
...
def scanteammatches():
    ...
    r = urlopen('https://api.vexdb.io/v1/get_matches?team=' + name + '&season=Turning%20Point')
...
def excelscanteams():  # 201
    ...
    while True:
        ...
        while number < len(list1):
            ...
            r = urlopen('https://api.vexdb.io/v1/get_rankings?team=' + str(teamloop) + '&season=Turning%20Point')
            ...
            print()
            print('wait ' + str(sleeptimer) + ' sec for next request to server...')
...
def excelgetalldata():  # 203
    ...
    while True:
        ...
        while number < int(len(list1)):
            ...
            from urllib.request import urlopen
            r = urlopen('https://api.vexdb.io/v1/get_rankings?team=' + teamloop + '&season=Turning%20Point')
            text = r.read()
            ...
            r = urlopen('https://api.vexdb.io/v1/get_matches?team=' + teamloop + '&season=Turning%20Point')
...
def searchteamcurrentseason():
    ...
    from urllib.request import urlopen
    r = urlopen('https://api.vexdb.io/v1/get_rankings?team=' + name + '&season=Turning%20Point')
    text = r.read()
...
def timeisout():
    # Input Team
    global_var.inputmode = str(input("Type in the preset value or 6 teams separate by ,\n"))
    teams = ""
...
def teamskill():
    from urllib.request import urlopen
    r = urlopen('https://api.vexdb.io/v1/get_skills?team=' + global_var.teamsent + '&season=Turning%20Point')
    text = r.read()
...
def teamranking():
    ...
    for r in json_dict["result"]:
        ...
        count += 1
        global_var.ranktotal = int(global_var.ranktotal) + int(global_var.teamranking)
...
def teamhighest():
    ...
    for r in json_dict["result"]:
        ...
        count += 1
        global_var.highesttotal = int(global_var.highesttotal) + int(global_var.teamhighest)
...
def teampr():
    ...
    for r in json_dict["result"]:
        ...
        count += 1
        global_var.oprtotal = float(global_var.oprtotal) + float(global_var.teamopr)
        global_var.oprave = float(global_var.oprtotal) / int(count)
        global_var.dprtotal = float(global_var.dprtotal) + float(global_var.teamdpr)
...
def teamccwm():
    ...
    for r in json_dict["result"]:
        ...
        global_var.ccwmtotal = float(global_var.ccwmtotal) + float(global_var.teamccwm)
...
def graphbubble():
    ...
    plt.text(x, y, str(global_var.teamr1), ha='center', va='center', fontweight='bold', color='red')
    ...
    plt.text(x, y, str(global_var.teamr2), ha='center', va='center', fontweight='bold', color='red')
    plt.scatter(x, y, s=z * 300, c="red", alpha=0.4, linewidth=6)
    ...
    plt.text(x, y, str(global_var.teamr3), ha='center', va='center', fontweight='bold', color='red')
    plt.scatter(x, y, s=z * 300, c="red", alpha=0.4, linewidth=6)
    ...
    plt.text(x, y, str("[" + global_var.teamr1 + "]"), ha='center', fontweight='bold', va='center', color='darkred')
    ...
    plt.text(x, y, str("[" + global_var.teamr2 + "]"), ha='center', fontweight='bold', va='center', color='darkred')
    plt.scatter(x, y, s=z * 50, c="deeppink", alpha=0.4, linewidth=6)
    ...
    if global_var.teamr3dpr != 0:
        ...
        plt.text(x, y, str("[" + global_var.teamr3 + "]"), ha='center', fontweight='bold', va='center', color='darkred')
        plt.scatter(x, y, s=z * 50, c="deeppink", alpha=0.4, linewidth=6)
    ...
    plt.text(x, y, str(global_var.teamb1), ha='center', va='center', fontweight='bold', color='royalblue')
    ...
    plt.text(x, y, str(global_var.teamb2), ha='center', va='center', fontweight='bold', color='royalblue')
    plt.scatter(x, y, s=z * 300, c="royalblue", alpha=0.4, linewidth=6)
    ...
    plt.text(x, y, str(global_var.teamb3), ha='center', va='center', fontweight='bold', color='royalblue')
    plt.scatter(x, y, s=z * 300, c="royalblue", alpha=0.4, linewidth=6)
    ...
    plt.text(x, y, str("[" + global_var.teamb1 + "]"), ha='center', va='bottom', fontweight='bold', color='dodgerblue')
    ...
    plt.text(x, y, str("[" + global_var.teamb2 + "]"), ha='center', va='bottom', fontweight='bold', color='dodgerblue')
    plt.scatter(x, y, s=z * 50, c="dodgerblue", alpha=0.4, linewidth=6)
    ...
    plt.title(
        "Red: " + global_var.teamr1 + " " + global_var.teamr2 + " " + global_var.teamr3 + " Blue: " + global_var.teamb1 + " " + global_var.teamb2 + " " + global_var.teamb3,
        loc="left")
